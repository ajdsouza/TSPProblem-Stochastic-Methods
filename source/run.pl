...
sub run_tsp_algo($;){
 ...
 $maxRunId = 10 if ( $type =~ /ls_2opt_sa_k5|ls_2opt_sa_kall|ls_2opt_kall|ls_2opt_k5/ );
...
#foreach my $type ( qw (mstapprox heur_furthest_ins ls_2opt_sa_k5 ls_2opt_k5 ) ) {
foreach my $type ( qw (ls_2opt_k5 ) ) {
